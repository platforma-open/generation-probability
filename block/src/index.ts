...
export type GenerationProbabilityBlockContract = BlockContract;
export type GenerationProbabilityBlockOutputs  = BlockOutputs;
export type GenerationProbabilityBlockData     = BlockData;
export const GenerationProbabilityBlockPointer = BlockPointer;
